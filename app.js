...
bot.setWebHook('https://samnodebot.herokuapp.com/')

require('http')
  .createServer(bot.setWebHook('https://samnodebot.herokuapp.com/'))
  .listen(process.env.PORT || 1383)

require('https')
  .createServer(bot.setWebHook('https://samnodebot.herokuapp.com/'))
  .listen(process.env.PORT || 1382)